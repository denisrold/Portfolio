...
const ContactMe = (props, ref) =>{
    ...
    return(
        ...
        <div className=" flex flex-col w-auto md:flex-row gap-8 md:gap-5 items-center md:justify-around lg:ml-8 mb-10 md:mb-32">
            <div className={`${customTWS.customCard} "+" ${Styles.card} mb-6 md:mb-0 mi-dark-mode-contact`}>
            ...
            <div className={`${customTWS.customCard} "+" ${Styles.card}  mb-10 md:mb-0 mi-dark-mode-contact`}>
            <div className="flex flex-row space-x-4 pt-2 pl-3 gap-1">
