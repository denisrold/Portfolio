...
export const IconsHAndlersHome =()=>{
    ...
    <img src={iconGHhome} onClick={handleClickGitHub} alt="Github logo" className='max-h-10 max-w-md w-10 shadow-xl rounded-full h-10 hover:scale-105 hover:brightness-110 hover:shadow-md cursor-pointer transition-all duration-300'/>
    <img src={iconLINhome} onClick={handleClickLinked} alt='LinkedIn logo' className='max-h-11 max-w-md w-10 shadow-xl rounded-full hover:scale-105 hover:brightness-110 hover:shadow-md cursor-pointer transition-all duration-300' />
    </div>)
}
