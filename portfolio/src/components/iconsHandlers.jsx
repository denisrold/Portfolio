...
export const IconsHAndlersHome =()=>{
    ...
    <img src={iconGHhome} onClick={handleClickGitHub} alt="Github logo" className='w-10 h-10 md:w-7 md:h-7 hover:scale-105 hover:brightness-110 cursor-pointer'/>
    <img src={iconLINhome} onClick={handleClickLinked} alt='LinkedIn logo' className='w-10  md:w-7  hover:scale-105 hover:brightness-110 cursor-pointer' />
    </div>)
}
