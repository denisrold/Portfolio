...
export const IconsHAndlersHome =()=>{
    ...
    <img src={iconGHhome} onClick={handleClickGitHub} alt="Github logo" className='w-8 h-8 hover:scale-105 cursor-pointer'/>
    <img src={iconLINhome} onClick={handleClickLinked} alt='LinkedIn logo' className='w-8 h-8 hover:scale-105 cursor-pointer' />
    </div>)
}
