const Navbar=()=>{
    return (
        <nav className="h-20  w-full bg-slate-300 fixed top-0 left-0 p-4 px-36 text-white tracking-wide shadow-md shadow-bottom">
            ...
            <button className="flex h-12 w-36 bg-blue-500 justify-around hover:bg-blue-700">Contact me</button>
            </div>
        </nav>
    )
    }
