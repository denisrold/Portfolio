    ...
    return (
        <nav className="h-20 z-10  w-full bg-blue-600 font-semibold fixed top-0 left-0 p-4 md:px-4 lg:px-36 text-white tracking-wide shadow-md shadow-bottom">
            ...
            <div className="w-full md:flex justify-between">
                ...
                <ul className={`${isMenuOpen ? 'absolute w-full left-0 mt-5 bg-slate-400 bg-opacity-50 z-0' : 'hidden'}  md:w-fit md:bg-transparent md:relative md:text-white md:flex md:mt-4 my-2 mr-8 mt-3 text-lg hover:transition-all duration-300}`}>
