...
const Footer=()=>{
    return (
        <footer className="absolute mt-auto left-0 bottom-0 flex flex-col-reverse items-center justify-center space-x-3 md:items-start md:flex-row md:space-x-48 lg:space-x-72 w-full h-32  bg-slate-600 ">
